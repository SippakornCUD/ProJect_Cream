...
list_cream_infer=[['Cetyl Alcohol',35],['Emulsifying Wax',40],['White Oil',50],['Polysorbate 20',10],['Stearic Acid',20],['Water',5],
                  ['Glycerin',35],['Kemaben 2',45],['Isopropyl Myristate',32],['Glyceryl Stearate',12],['Mineral Oil',34],
                  ['Ethylhexyl Methoxycinnamate',30],['Niacinamide',25],['Petrolatum',26],['Butyl Methoxycinnamate',29],
                  ['Tocopheryl Acetate',18],['Sodium Ascorbyl phosphate',40]]
list_cream_forloop=[['Cetyl Alcohol : 35 THB'],['Emulsifying Wax : 40 THB'],['White Oil : 50 THB'],['Polysorbate 20 : 10 THB'],
                    ['Stearic Acid : 20 THB'],['Water : 5 THB'],['Glycerin : 35'],['Kemaben 2 : 45 THB'],['Isopropyl Myristate : 32 THB'],
                    ['Glyceryl Stearate : 12 THB'],['Mineral Oil : 34 THB'],['Ethylhexyl Methoxycinnamate : 30 THB'],
                    ['Niacinamide : 25 THB'],['Petrolatum : 26 THB'],['Butyl Methoxycinnamate : 29 THB'],['Tocopheryl Acetate : 18 THB'],
                    ['Sodium Ascorbyl phosphate : 40 THB']]
bucketinfercream=[]
